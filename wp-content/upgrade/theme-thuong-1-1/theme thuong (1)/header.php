<!DOCTYPE html><html lang="en"><head>
    ...
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/images/UoBxWFutUnjT.png" sizes="16x16">
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/images/DqZLWIlA88EI.png" sizes="32x32">
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/images/4rLqBrcv9b13.png" sizes="96x96">
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/images/ma6JIWIVfRFl.png" sizes="192x192">
    ...
    <meta property="og:image" content="images/JwHRL0eeBPJ6.png">
    ...
    <meta name="twitter:image" content="https://appilix.com/styles/images/JwHRL0eeBPJ6.png">

    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/PMo7STDapImC.css" type="text/css" media="all">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/52cDAcSoF6Et.css" type="text/css" media="all">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/OVPQyj0IsACH.css" type="text/css" media="all">
    ...
    "image": "https://appilix.com/styles/images/schema/schema_logo.png",
...
<nav class="appilix_nav_bar">
  ...
  <?php
    wp_nav_menu(array(
        'theme_location' => 'primary', // Tên location bạn sẽ đăng ký
        'container' => false, // Không bọc thêm <div>
        'menu_class' => 'menu_items', // Thêm class vào <ul>
    ));
  ?>
</div>

      <div class="nav_bar_btns">
                <a href="https://appilix.com/contact-us" class="login">Contact</a>
                <a href="https://appilix.com/account" class="account">Account</a>
            </div>
